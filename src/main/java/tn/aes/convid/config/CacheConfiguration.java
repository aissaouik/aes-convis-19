...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tn.aes.convid.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tn.aes.convid.repository.UserRepository.USERS_BY_EMAIL_CACHE);
