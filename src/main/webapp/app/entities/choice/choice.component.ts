...
export class ChoiceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.choiceService
      ...
      .subscribe(
        (res: HttpResponse<IChoice[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInChoices(): void {
    this.eventSubscriber = this.eventManager.subscribe('choiceListModification', () => this.loadPage());
  }
